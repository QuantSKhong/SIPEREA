...
Public Class NaturalComparer
   ...
   End Enum
    ...
    'Sample usage
    'Dim srcarray() As String = {"chapter 13", "close 1", "chapter 11", "chapter 05", "close 3",
    '                           "23", "5", "45", "56 song", "23", "06", "101", "56 pop", "31 pop", "276", "19"}
    '
    'Array.Sort(srcarray, New NaturalComparer(NaturalComparerOptions.RomanNumbers))
